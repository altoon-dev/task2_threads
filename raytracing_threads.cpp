...
void threadFunc(Scene &scene, ViewPlane &viewPlane, Image &image, int start, int end, int sizeX, int sizeY, int numOfSamples) {
...
int main(int argc, char **argv) {
    ...
    thread thr(threadFunc, ref(scene), ref(viewPlane), ref(image),start, end, 
            viewPlaneResolutionX, viewPlaneResolutionY, numOfSamples);
